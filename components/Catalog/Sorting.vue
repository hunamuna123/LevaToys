				...
				<div class="hs-dropdown-menu hs-dropdown-open:scale-100 border border-gray-100 hs-dropdown-open:opacity-100 scale-95 opacity-0 z-10 ease-in-out transition-[transform,opacity] duration-200 min-w-60 bg-white shadow-lg rounded-lg hidden"
					...
					<div class="p-1 space-y-0.5">
						<button type="button" :class="[
							...
							activeSort === 'data_desc' ? 'bg-orange-500 text-gray-100' : 'text-black hover:bg-gray-100 focus:bg-gray-100'
						...
						<button type="button" :class="[
							'flex items-center w-full justify-between gap-x-3.5 py-2 px-3 rounded-lg text-sm transition-colors duration-200 cursor-pointer',
							activeSort === 'data_asc' ? 'bg-orange-500 text-gray-100' : 'text-black hover:bg-gray-100 focus:bg-gray-100'
						...
						<button type="button" :class="[
							'flex items-center w-full justify-between gap-x-3.5 py-2 px-3 rounded-lg text-sm transition-colors duration-200 cursor-pointer',
							activeSort === 'price_desc' ? 'bg-orange-500 text-gray-100' : 'text-black hover:bg-gray-100 focus:bg-gray-100'
						...
						<button type="button" :class="[
							'flex items-center w-full justify-between gap-x-3.5 py-2 px-3 rounded-lg text-sm transition-colors duration-200 cursor-pointer',
							activeSort === 'price_asc' ? 'bg-orange-500 text-gray-100' : 'text-black hover:bg-gray-100 focus:bg-gray-100'
