		...
		<div class="flex flex-row gap-3">
			...
			>
				<button
					...
					type="button"
					class="hs-dropdown-toggle py-2.5 px-6 flex justify-center items-center gap-2 font-medium text-sm rounded-full border border-gray-200 bg-white text-black hover:bg-gray-200 focus:outline-none focus:bg-gray-200 transition-colors duration-200"
					aria-haspopup="menu"
					aria-expanded="false"
					aria-label="Dropdown"
				>
