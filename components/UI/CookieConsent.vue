<template>
  ...
  >
    <div v-if="showBanner" class="fixed bottom-0 end-0 z-[9999] sm:max-w-xl w-full mx-auto p-6">
      <!-- Card -->
        ...
        <div class="flex gap-x-5">
          ...
          <div class="grow">
            ...
            <p class="mt-2 text-sm text-gray-600">
              By clicking "Allow all", you agree to use of all cookies. Visit our <a class="inline-flex items-center gap-x-1.5 text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium" href="#">Cookies Policy</a> to learn more.
            </p>
            <div class="mt-5 inline-flex gap-x-2">
              <button @click="acceptAll" type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                Allow all
              </button>
              <button @click="manageCookies" type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none">
                Manage cookies
              </button>
            </div>
          </div>
...
const manageCookies = () => {
  // Here you can implement cookie management logic
