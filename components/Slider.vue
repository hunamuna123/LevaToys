        ...
        <div class="px-4 sm:px-6 lg:px-8 mx-auto  mt-6">
            ...
            <div class="hs-carousel relative overflow-hidden w-full min-h-96 bg-white rounded-lg">
                ...
                <div class="hs-carousel-slide">
                    ...
                    <span class="self-center text-4xl text-gray-800 transition duration-700">Первый слайд</span>
                    </div>
                </div>
                <div class="hs-carousel-slide">
                    <div class="flex justify-center h-full bg-gray-200 p-6">
                    <span class="self-center text-4xl text-gray-800 transition duration-700">Второй слайд</span>
                    </div>
                </div>
                <div class="hs-carousel-slide">
                    <div class="flex justify-center h-full bg-gray-300 p-6">
                    <span class="self-center text-4xl text-gray-800 transition duration-700">Третий слайд</span>
                    </div>
                </div>
                </div>
            </div>
